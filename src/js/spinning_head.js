...
function AaronCruz() {
  ...
  this.fuckingRainbow = ["red", "orange", "yellow", "green", "blue", "purple"]
  this.duration = 2000
...
AaronCruz.prototype.changeColor = function() {
  this.fuckingRainbow.unshift(this.fuckingRainbow.pop())
  var opts = { color: this.fuckingRainbow[0] }
  var self = this
  this.logo.animate(opts, this.duration, "easeInSine", function() {
    self.changeColor()
  })
...
AaronCruz.prototype.rotateFuckingHeadAroundFuckingName = function() {
  jQuery("#my-head").css({opacity: 0}).animate({opacity: 1}, 1000)
}
